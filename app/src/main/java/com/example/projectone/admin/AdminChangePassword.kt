...
class AdminChangePassword : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lastPasswordET = findViewById(R.id.etAdminLastPassword)
        newPasswordET = findViewById(R.id.etAdminNewPassword)
        newConfirmPasswordET = findViewById(R.id.etAdminConfirmNewPassword)
        btnChangePassword = findViewById(R.id.btnChangePassword)
        val adminToolbarChangePassword = findViewById<Toolbar>(R.id.AdminToolbarChangePassword)
